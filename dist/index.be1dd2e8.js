...
})({"5UyJx":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "30106ce1be1dd2e8";
"use strict";
...
},{}],"gdBRk":[function(require,module,exports,__globalThis) {
var _filterBooksJs = require("./filterBooks.js");
var _bookOperationsJs = require("./bookOperations.js");
var _chatbotJs = require("./chatbot.js");
(0, _chatbotJs.initializeChatbot)();
document.addEventListener("DOMContentLoaded", ()=>{
    (0, _bookOperationsJs.initializeModals)(); // Set up modal events
    ...
    sendBtn.addEventListener("click", async ()=>{
        ...
        chatInput.value = "";
        const handled = await (0, _chatbotJs.handleLocalCommands)(userInput, appendMessage);
        if (handled) return;
        const botReply = await (0, _chatbotJs.askChatBot)(userInput);
    ...
    if (bookForm) bookForm.addEventListener("submit", async (e)=>{
        ...
        if (title && author && genre && rating) {
            await (0, _bookOperationsJs.addBook)(title, author, genre, rating);
            bookForm.reset();
        }
    });
    ...
    bookList.addEventListener("click", (e)=>{
        if (e.target.classList.contains("edit-btn")) {
            ...
            (0, _bookOperationsJs.showEditModal)(bookId);
        } else if (e.target.classList.contains("delete-btn")) {
            const bookId = e.target.getAttribute("data-id");
            (0, _bookOperationsJs.showDeleteModal)(bookId);
        }
    });
...
},{"./chatbot.js":"zjufB","./bookOperations.js":"4jJrD","./filterBooks.js":"2aJK5"}],"zjufB":[function(require,module,exports,__globalThis) {
// chatbot.js
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initializeChatbot", ()=>initializeChatbot);
parcelHelpers.export(exports, "askChatBot", ()=>askChatBot);
// Processes local commands (help, Q&A, troubleshooting, explain feature, add, edit, delete, suggest)
parcelHelpers.export(exports, "handleLocalCommands", ()=>handleLocalCommands);
...
async function initializeChatbot() {
    const snapshot = await (0, _firestore.getDoc)((0, _firestore.doc)((0, _firebaseJs.db), "apikey", "googlegenai"));
...
async function handleLocalCommands(userInput, appendMessage) {
    ...
    if (lowerInput.includes("what does") && lowerInput.includes("button") && lowerInput.includes("do")) {
        if (lowerInput.includes("add book")) appendMessage("The 'Add Book' button submits a form when you input a new book's details (Title, Author, Genre, Rating) to add it to your log.", "bot");
        else if (lowerInput.includes("edit")) appendMessage("The 'Edit' button opens a modal that lets you update the details of the selected book.", "bot");
        else if (lowerInput.includes("delete")) appendMessage("The 'Delete' button opens a confirmation modal to remove the selected book from your log.", "bot");
        else appendMessage("I can explain any feature. For example, try asking 'What does the add book button do?'", "bot");
        return true;
    }
    // Command: Add Book
    if (lowerInput.startsWith("add book")) {
        ...
        if (parts.length >= 2) {
            ...
            } else appendMessage("Please provide details as: add book Title by Author, Genre, Rating", "bot");
        } else appendMessage("Please provide complete details: add book Title by Author, Genre, Rating", "bot");
        return true;
    }
    ...
    if (lowerInput.startsWith("edit book")) {
        ...
        if (parts.length === 5) {
            ...
            (0, _bookOperationsJs.editBook)(oldTitle, newTitle, newAuthor, newGenre, newRating).then((success)=>{
                if (success) appendMessage(`Updated book "${oldTitle}" to: Title: "${newTitle}", Author: "${newAuthor}", Genre: "${newGenre}", Rating: "${newRating}"`, "bot");
                else appendMessage(`Book "${oldTitle}" not found.`, "bot");
            });
        } else appendMessage('Use: "edit book Old Title, New Title, New Author, New Genre, New Rating"', "bot");
        return true;
    }
    // Command: Delete Book
    if (lowerInput.startsWith("delete book")) {
        ...
        if (title) {
            const success = await (0, _bookOperationsJs.deleteBookByTitle)(title);
            if (success) appendMessage(`Deleted book "${title}"`, "bot");
            else appendMessage(`Book "${title}" not found.`, "bot");
        } else appendMessage("Please specify a book to delete: delete book Title", "bot");
        return true;
    }
}

},{"@google/generative-ai":"gKJrW","firebase/firestore":"8A4BC","./firebase.js":"eUV3w","./bookOperations.js":"4jJrD","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gKJrW":[function(require,module,exports,__globalThis) {
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4jJrD":[function(require,module,exports,__globalThis) {
// bookOperations.js
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
//function to add a book
parcelHelpers.export(exports, "addBook", ()=>addBook);
parcelHelpers.export(exports, "editBook", ()=>editBook);
//function to delete a book
parcelHelpers.export(exports, "deleteBookByTitle", ()=>deleteBookByTitle);
...
parcelHelpers.export(exports, "loadBooks", ()=>loadBooks);
//function to display a book
parcelHelpers.export(exports, "displayBook", ()=>displayBook);
parcelHelpers.export(exports, "initializeModals", ()=>initializeModals);
parcelHelpers.export(exports, "showEditModal", ()=>showEditModal);
parcelHelpers.export(exports, "hideEditModal", ()=>hideEditModal);
parcelHelpers.export(exports, "showDeleteModal", ()=>showDeleteModal);
parcelHelpers.export(exports, "hideDeleteModal", ()=>hideDeleteModal);
var _firestore = require("firebase/firestore");
var _firebaseJs = require("./firebase.js");
...
async function editBook(oldTitle, newTitle, newAuthor, newGenre, newRating) {
    try {
        ...
        const bookDoc = snapshot.docs.find((doc)=>doc.data().title.toLowerCase() === oldTitle.toLowerCase());
        if (bookDoc) {
            await (0, _firestore.updateDoc)((0, _firestore.doc)((0, _firebaseJs.db), "books", bookDoc.id), {
                title: newTitle,
                author: newAuthor,
                genre: newGenre,
                rating: newRating
...
async function deleteBookByTitle(title) {
    try {
        const booksCollection = (0, _firestore.collection)((0, _firebaseJs.db), "books");
        const snapshot = await (0, _firestore.getDocs)(booksCollection);
        const bookDoc = snapshot.docs.find((doc)=>doc.data().title.toLowerCase() === title.toLowerCase());
        if (bookDoc) {
            await (0, _firestore.deleteDoc)((0, _firestore.doc)((0, _firebaseJs.db), "books", bookDoc.id));
            await loadBooks();
            return true;
        }
        return false;
...
function initializeModals() {
    ...
    if (editForm) editForm.addEventListener("submit", async (e)=>{
        ...
        try {
            await (0, _firestore.updateDoc)((0, _firestore.doc)((0, _firebaseJs.db), "books", currentBookId), {
                title: updatedTitle,
...
function showEditModal(bookId) {
    (0, _firestore.getDoc)((0, _firestore.doc)((0, _firebaseJs.db), "books", bookId)).then((docSnap)=>{
        if (docSnap.exists()) {
...
},{"firebase/firestore":"8A4BC","./firebase.js":"eUV3w","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2aJK5":[function(require,module,exports,__globalThis) {
// filterBooks.js
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"firebase/firestore":"8A4BC","./firebase.js":"eUV3w","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5UyJx","gdBRk"], "gdBRk", "parcelRequire94c2")

//# sourceMappingURL=index.be1dd2e8.js.map
